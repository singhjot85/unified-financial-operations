...
<template>
  <div class="min-h-screen flex flex-col bg-background">
    ...
    <main class="flex-grow flex flex-col items-center">
      ...
      <section
        class="w-full max-w-container-max mx-auto px-sm md:px-xl py-xl flex flex-col gap-xl -mt-xl relative z-20"
      >
        <!-- Campaign Snapshot Card -->
        <div
          class="bg-surface rounded-2xl border border-outline-variant/60 shadow-sm p-8 md:p-10 flex flex-col items-center text-center gap-4"
        >
          ...
          <div
            class="mt-2 flex items-center gap-2 text-[#00685F] bg-[#E6F7F5] border border-[#00685F]/10 px-4 py-1.5 rounded-full text-xs font-semibold select-none"
          >
            <span
              class="material-symbols-outlined text-[15px]"
              style="font-variation-settings: 'FILL' 0; font-weight: 600"
        ...
        <div class="border-t border-outline-variant/50 pt-8 mt-4">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            <div
              class="flex flex-col md:flex-row items-center justify-center gap-3 text-center md:text-left"
            >
              <span class="material-symbols-outlined text-[#00685F] text-[32px]">visibility</span>
              <span class="text-sm font-sans font-semibold text-on-surface"
                >100% Transparent Tracking</span
              >
            </div>

            <div
              class="flex flex-col md:flex-row items-center justify-center gap-3 text-center md:text-left border-y md:border-y-0 md:border-x border-outline-variant/50 py-4 md:py-0 md:px-4"
            >
              <span class="material-symbols-outlined text-[#00685F] text-[32px]">receipt_long</span>
              <span class="text-sm font-sans font-semibold text-on-surface"
                >Instant Tax Receipts</span
              >
            </div>
            ...
            >
              ...
              <span class="text-sm font-sans font-semibold text-on-surface"
                >Secure Encrypted Payments</span
              >
            </div>
          </div>
        </div>
